...
def main(args):
    ...
    for it in range(0, args.num_experts):
        ...
        num_params = sum(p.numel() for p in teacher_net.parameters())
        teacher_net.train()
        lr = args.lr_teacher
        ...
        # timestamps.append(teacher_net.state_dict())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--teacher_label', action='store_true', default=False, help='Not used here')
    parser.add_argument('--selection_strategy', type=str, default='random', help='Not used here')
